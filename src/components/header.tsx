    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.title}>
                <Typography variant="h5"><b>Tirilla Digital</b></Typography>
                <Typography align="center">¡Hola! Te presentamos tu tirilla digital para la revisión y descarga de ella</Typography>
            </div>
        </div>
    );
};
